...
"""
=>Optical flow
->it uses image feature points to track an object
-> individual feature points are tracked across successive frames
-> motion vectors show motion of feature points between successive frames
-> Lucas-Kanade method is the most popular for tracking purpose
...
#First Define a function to track the object
def start_tracking():
    ...
    while True:
        ...
        if len(tracking_paths)>0:
            ...
            # Iterate through ali the good feature points
            ...
            #append the x and y coordinates and check if its length greater then the threshold
            tp.append((x,y))
            ...
            # Draw a circle around th feature points
        ...
        if not frame_index%num_frames_jump:
            ...
            # Check if feature points exits if so , append them to the tracking paths
        ...
        # Update variables
        frame_index+=1
        prev_gray=frame_gray #startpoint

        # Display output
        cv2.imshow('Optival Flow',output_img)
