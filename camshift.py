...
"""
-> camshift or continuously adaptive mean shift is a color based object tracking algo.
-> It uses Histogram backprojection of the window of the targeted object's color distribution 
and it will finds the same color distribution in each frame
-> camshift is an enhanced version of the meanshift algorithm and provides more accuracy 
and robustness to the model
-> tracking is done by using the color information of the object
"""
# ==========================================================================================
"""
How to check this program:-

-> first click the mouse on window and drag it to select object (Select the object)
-> it will create the an ellipse around it and as we move that object it will change its position
i.e. object is tracking
"""
...
class ObjectTracker(object):
    def __init__(self, scaling_factor=0.5):
        ...
        self.cap = cv2.VideoCapture('C:\\Users\\SATYAM\\Desktop\\MLProj\\Objtrack.mp4')
